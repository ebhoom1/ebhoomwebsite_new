...
//   return (
//     <footer  
//     className="bg-secondary text-white py-8 z-20 mt-20"
//      >
...
const Footer = () => {
  return (
    ...
    >
      <div className="container mx-auto px-4">
        {/* Logo and Contact Info */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-6"> {/* Kept as md:grid-cols-3 */}
          {/* Logo Section */}
          <div className="text-left">
            <div className="bg-white p-3 rounded-full shadow-lg">
              <img src={headerLogo} alt="EBHOOM Solutions" className="w-24" />
          ...
          <div className="text-left max-w-sm">
            <h3 className="font-semibold text-xl mb-2">Contact</h3> {/* Main heading for addresses */}
            {/* Kochi Office */}
            <div className="mb-4"> {/* Added margin-bottom for separation */}
              <h4 className="font-semibold text-base mb-1">Kochi Office</h4> {/* Sub-heading */}
              <p className="text-sm">
            ...
            {/* Head Office */}
            <div>
              <h4 className="font-semibold text-base mb-1">Head Office</h4> {/* Sub-heading */}
              <p className="text-sm">
